...
if [[ "${composition_mode}" == "clean" ]]; then
  ...
  configure_b12x_composition \
    "patches/releases/gilded-gnosis-v20-r30/b12x" 0
  configure_lmcache_composition \
    "patches/releases/gilded-gnosis-v20-r30/lmcache" 0

  export IMAGE="${IMAGE:-voipmonitor/vllm:gilded-gnosis-v20-vllm20ed7f9-b12x6bc35fd-fi801d57a-cu132-20260807-r30}"
  export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev280+gilded.gnosis.v20.vllm20ed7f9.b12x6bc35fd.fi801d57a.cu132.20260807.r30}"
  ...
  export IMAGE="${IMAGE:-voipmonitor/vllm:gilded-gnosis-v20-vllme1e9426-si200c1db-fi801d57a-cu132-20260804-r28}"
  export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev280+gilded.gnosis.v20.vllme1e9426.si200c1db.fi801d57a.cu132.20260804.r28}"
...
if [[ "${composition_mode}" == "clean" || "${composition_mode}" == "reproduce-r31" ]]; then
  export LAUNCHER_REF="${LAUNCHER_REF:-fe8f720ac2f9434ef25b0f617fc8a08ca2c0bd1a}"
  export LAUNCHER_COMMIT="${LAUNCHER_COMMIT:-fe8f720ac2f9434ef25b0f617fc8a08ca2c0bd1a}"

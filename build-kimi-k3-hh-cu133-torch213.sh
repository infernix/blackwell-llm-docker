...
release_name="${RELEASE_NAME:-kimi-k3-hh-cu133-torch213}"
...
read_lock vllm VLLM
read_lock b12x B12X
vllm_package_version="${VLLM_PACKAGE_VERSION:-0.11.2.dev280+hh.${VLLM_INTEGRATION_TREE:0:7}.cu133.torch213}"
...
image="${IMAGE:-voipmonitor/vllm:kimi-k3-hh-vllm${VLLM_INTEGRATION_TREE:0:7}-b12x${B12X_INTEGRATION_TREE:0:7}-cu133-torch213-${release_date}-${revision}}"
...
DOCKER_BUILDKIT=1 docker build \
  ...
  --file Dockerfile.kimi-k3-hh-cu133-torch213 \
  --tag "${image}" \
  .

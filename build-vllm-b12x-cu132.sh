...
LMCACHE_PATCH_SHA256="${LMCACHE_PATCH_SHA256:-0303a0010e60e179609a91210c65d53e01747f8e1a173804899e15bd7939811f}"
LMCACHE_BUILD_VERSION="${LMCACHE_BUILD_VERSION:-0.5.2+glm52dcp}"

...
LMCACHE_REF="${LMCACHE_REF:-v0.5.2}"
LMCACHE_PATCH_FILE="${LMCACHE_PATCH_FILE:-lmcache/glm52-dcp-v052.patch}"
LMCACHE_PATCH_SHA256="${LMCACHE_PATCH_SHA256:-504434b7d0ccd7bffa2b01a716ad0471405fa6dad8b2ba78a3b0ec4b8627a255}"
LMCACHE_BUILD_VERSION="${LMCACHE_BUILD_VERSION:-0.5.2+glm52dcp.2}"

...
grep -Fq 'ARG INSTANTTENSOR_LIBAIO_REPO=https://pagure.io/libaio.git' "${dockerfile}"
...
grep -Fq 'instanttensor_libaio_repo=${INSTANTTENSOR_LIBAIO_REPO:-https://pagure.io/libaio.git}' "${builder}"
